...
public class AnimalResponse  implements Serializable  {
  ...
  public AnimalResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public AnimalResponse species(String species) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, animalResponse.id) &&
        Objects.equals(this.name, animalResponse.name) &&
        Objects.equals(this.species, animalResponse.species) &&
